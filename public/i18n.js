...
(function () {
  ...
  const DICT = {
    uz: {
      ...
      "banner.t": "Tez, ishonchli, milliy",
      "banner.s": "Sevimli o'yinlaringiz va raqamli xizmatlar uchun qulay to'lov",
      "banner.c1": "Tezkor yetkazish",
      "banner.c2": "Xavfsiz to'lov",
      "banner.c3": "24/7 yordam",
    ...
    ru: {
      ...
      "banner.t": "Быстро, надёжно, по-своему",
      "banner.s": "Удобная оплата любимых игр и цифровых услуг",
      "banner.c1": "Быстрая доставка",
      "banner.c2": "Безопасная оплата",
      "banner.c3": "Поддержка 24/7",
