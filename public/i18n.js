...
(function () {
  ...
  const DICT = {
    uz: {
      ...
      "topup.howSub": "Bosqichma-bosqich qo'llanma",
      "topup.help": "Texnik yordam",
      "topup.helpSub": "Operator bilan bog'lanish",
      ...
      "promo.mine": "Saqlangan promokod",
      "promo.clear": "O'chirish",
    ...
    ru: {
      ...
      "topup.howSub": "Пошаговая инструкция",
      "topup.help": "Техподдержка",
      "topup.helpSub": "Связаться с оператором",
      ...
      "promo.mine": "Сохранённый промокод",
      "promo.clear": "Убрать",
